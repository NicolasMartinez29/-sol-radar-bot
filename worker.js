...
// ============================================================
// RAPID RADAR LOOP — CALLED EVERY MINUTE
// ============================================================
...
async function runRadar(env) {
  ...
  try {
    ...
    const movedUp =
      STAGE_RANK[analysis.stage] >
      STAGE_RANK[previousStage];
    ...
    // --------------------------------------------------------
    // 1) MANAGE OPEN PAPER TRADES EVERY MINUTE
    // --------------------------------------------------------
    ...
    // --------------------------------------------------------
    // 3) OPEN PAPER TRADE ONLY ON ENTRY INTO SIGNAL
    // --------------------------------------------------------
    ...
    // --------------------------------------------------------
    // 4) SNAPSHOT HISTORY EVERY ~5 MINUTES
    // --------------------------------------------------------
...
// ============================================================
// MARKET DATA — COINBASE 1-MINUTE CANDLES
// ============================================================
...
// ============================================================
// MANAGE PAPER TRADES EVERY MINUTE
// ============================================================
